...
export default function AIChat() {
  ...
  const handleQuickResponse = (response: { text: string }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">24/7 AI-powered support for immediate assistance and guidance</p>
      </div>
                  ...
                  >
                    ...
                    {(msg as any).options && (
                      <div className="mt-3 space-y-2">
                        {(msg as any).options.map((option: string, index: number) => (
                          <Button
                            key={index}
                            variant="outline"
                            size="sm"
